<?php 
// Language d'installation.
$install_firststep = 'Installation - Étape 1';
$install_install = 'Installation';
$install_information = '- Information';
$install_servername = 'Nom de votre serveur';
$install_ip = 'IP de votre serveur';
$install_port = 'Port de votre serveur';

$install_secondstep = 'Installation - Étape 2';
$install_database = '- Base de donnée';
